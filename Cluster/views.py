...
def home(request):
    ...
    if(request.method=='POST' and myfile!=False):
        ...
        if(selected_file is not None):
                ...
                plt.savefig(loc+'age_distribution.png')
                plt.clf()
                ...
                plt.savefig(loc+'default_cases.png')
                plt.clf()
                ...
                plt.savefig(loc+'age_income.png')
                plt.clf()
                ...
                plt.savefig(loc+'c_age_income.png')
                plt.clf()
